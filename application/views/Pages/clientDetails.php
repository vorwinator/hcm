    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row content justify-content-center">
                ...
                <table id="client" class="display">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>1</td>
                            <td>
                                <a href="#">Konta hostingowe</a>
                                <a href="#">Dodaj usługę</a>
                                </td>
                        </tr>  
                    </tbody>
                </table>

                Ogólne informacje o hostingach

                <table id="overallClientHostingInfo">
                    <thead>
                ...
                <table id="paymentInfo" class="display">
                    <thead>
                        <th>Id</th>
                ...
                Zakupione usługi
                <table id="purchasedServices" class="display">
                    <thead>
                        <th>Id</th>
                        <th>Rodzaj</th>
                        <th>Nazwa</th>
