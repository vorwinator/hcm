        ...
        <div class="container-fluid">
            ...
            <div class="row currLocationBaner">
                <div class="col-10 locationBanerItem align-self-center">
                    Klienci > Lista domen > Artneo Sp. z o.o. > jakiś hosting
                </div>
            </div>
            <div class="row content justify-content-center">
                
                <table id="hostingDomains" class="display">
                    <thead>
                        <th>Id</th>
                        <th>URL</th>
                        <th>Nazwa</th>
                        <th>Trzon domeny</th>
                        <th>Wersja php</th>
                        <th>Limit skrzynek pocztowych</th>
                        <th>Zajętość skrzynek pocztowych</th>
                        <th>Właściciel</th>
                        <th>Hosting</th>
                        <th>Opcje</th>
                    </thead>
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td>https://fps_rtg_kgb_cba.karaoke</td>
                            <td>Karaoke</td>
                            <td>fps_rtg_kgb_cba</td>
                            <td>100</td>
                            <td>10</td>
                            <td>300</td>
